...
class StoryGenerator:
    ...
    @classmethod
    def generate_story(cls, db: Session, session_id: int, theme: str = "fantasy") -> Story:
        llm = cls._get_llm()
    ...
    def _process_story_node(cls, db: Session, story_id: int, node_data: StoryNodeLLM, is_root: bool = False) -> StoryNode:
        node = StoryNode(
            ...
            is_root=is_root,
            isEnding=node_data.isEnding if hasattr(node_data, "isEnding") else node_data["isEnding"],
        ...
        if not node.isEnding and (hasattr(node_data, "options") and node_data.options):
            options_list = []
